...
if(isset($_GET['add']) and !empty($_POST))
{
	...
	$gelirFirma = $_POST['firma'];
			...
			$stmt = $con->prepare("INSERT INTO gelir (gelirAd,gelirTutar,gelirTur,gelirFirma) values(?,?,?,?)");
			$stmt->bind_param('ssss',$gelirAd,$gelirTutar,$gelirTur,$gelirFirma);
			if($stmt->execute())
			{
				$logId = $_SESSION['user_id'];
				$logData = "Gelir: ".$gelirAd." Tutar: ".$gelirTutar." Tur: ".$gelirTur." Firma".$gelirFirma;
				$action = "Added";
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Gelir Listesi</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Gelir</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
																...
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	...
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Gelir Adı</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="gelirAd" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Gelir Adı"  />
																			<!--end::Input-->
																		</div>
																		
																		<!--end::Input group-->
																		<label class="required fw-semibold fs-6 mb-2">Gelir Tutarı</label>
																	<div class="fv-row mb-12 d-flex justify-content-between align-items-center">
																		...
																		<div class="col-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="gelirTutar" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Gelir Tutarı"  /> 
																		
																		</div>
																			<div class="col-4">
																			<select class="form-select form-control form-control-solid mb-3 mb-lg-0" name="gelirTur" aria-label="Select example">
																			<option>Birim</option>
																					<option>Tl</option>
																					<option>Dolar</option>
																					<option>Euro</option>
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="firma" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Firma"  /><!--end::Input-->
																		</div>
										...
										<div class="card-body py-4">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Gelir Ad</th>
														<th class="min-w-125px">Tutar</th>
														<th class="min-w-125px">Gelir Firma</th>
												...
												<?php 
											$stmt = $con->prepare("SELECT * from gelir ORDER BY create_time DESC");
											if($stmt->execute())
											{
											...
											?>
													<tr>
														...
														<td><a href="income-edit.php?id=<?=$encrypted_id?>"  class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"><?=$row->gelirAd?></a></td>
														<td><?=number_format($row->gelirTutar,0,',','.')?> <?=$row->gelirTur?></td>
														<td><?=$row->gelirFirma?></td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="income-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
...
var KTUsersList = function() {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response == 1) {
                                        ...
                                        Swal.fire({
                                            text: r + " Başarıyla silindi! "+ response,
                                            icon: "success",
                                            buttonsStyling: false,
    ...
    if (o) {
        ...
        // DataTable yeniden çizildiğinde çağrılan işlevler
        e.on("draw", function() {
            l();
            c();
            a();
...
l();
 document.querySelector('[data-kt-user-table-filter="search"]').addEventListener("keyup", (function(t) {
        ...
        $('#kt_table_users thead').append('<tr class="search-row"></tr>');

        // Her sütun için bir th ekleyin ve belirli sütunlara arama kutusu eklemeyin
        $('#kt_table_users thead th').each(function(index) {
            var title = $(this).text();
        ...
        e.columns().every(function(index) {
            ...
            if (index !== 1 && index !== 2) { // 1 ve 2 sütunlarına arama eklenmez
                var that = this;
        ...
        // İlk başlatma sırasında olay dinleyicilerini bağlama
        c();
    }
}
