...
if(isset($_GET['add']) and !empty($_POST))
{
	...
	$image =  $_FILES['image']['name'];
			...
			$stmt = $con->prepare("INSERT INTO urun (urun_no,urun_ad,urun_adet,urun_fiyat,image) values(?,?,?,?,?)");
			$stmt->bind_param('sssss',$urunNo,$urunAd,$urunAdet,$urunFiyat,$image_name);
			if($stmt->execute())
			{
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ürün Listesi</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
															...
															<div class="modal-body px-5 my-7">
																...
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	...
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Ürün Ad</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="urun-ad" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ürün Ad"  />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="urun-adet" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Adet"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Fiyat</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="urun-fiyat" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Fiyat"  />
																			<!--end::Input-->
																		</div>
																	</div>
																	<!--end::Scroll-->
										...
										<div class="card-body py-4">
											...
											<thead>
												...
												if(isset($_GET['id']))
												{
													...
													$stmt = $con->prepare("SELECT * FROM urun where id = ? ORDER BY create_time DESC");
													$stmt->bind_param("i",$id);
													
												}
												else {
														$stmt = $con->prepare("SELECT * FROM urun ORDER BY create_time DESC");
													...
													<tr>
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="product-edit.php?id=<?=$encrypted_id?>" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"><?=$row->urun_ad?></a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														...
														<td class="text-center pe-0"><?=$row->urun_fiyat?> ₺</td>
														...
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="product-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
