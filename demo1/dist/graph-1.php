...
if (isset($_GET['mobile_login'],$_GET['user_id'])) {
	...
	header('Location:mobile/graph-1.php');
	exit;
}
}
...
<html lang="en">
	...
	<head><base href=""/>
		...
		.goog-te-combo {
			...
			border: none;
			border-bottom: 2px solid #D3D4EC;
		}
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div id="google_translate_element" class="px-5"></div>
										</div>
											...
											<div class="card card-flush h-md-50 mb-10 mb-xl-12 col-print-4">
												...
												<div class="card-header pt-5">
													...
													<div class="card-toolbar print" style="float:right;position:absolute;right:10px;top:20px;">
																...
																<button class="btn btn-light-warning p-3 d-flex justify-content-center align-items-center kt_button_class" style="margin-right:10px" data-table="siparisler" data-name="adet" data-time="6"  data-bs-toggle="modal" data-bs-target="#kt_modal_1"><i class="fa-solid fa-microchip-ai " style="font-size:20px"></i> 6 Ay</button>
																<button class="btn btn-light-danger  p-3 d-flex justify-content-center align-items-center kt_button_class" style="margin-right:10px" data-table="siparisler" data-name="adet" data-time="12"   data-bs-toggle="modal" data-bs-target="#kt_modal_1"><i class="fa-solid fa-microchip-ai " style="font-size:20px"></i> 1 Yıl</button>
											...
											<div class="card card-flush overflow-hidden ">
												...
												<div class="card-header py-5">
													...
													<div class="card-toolbar print" style="float:right;position:absolute;right:10px;top:20px;">
															...
															<button class="btn btn-light-warning p-2 d-flex justify-content-center align-items-center kt_button_class" style="margin-right:10px" data-table="satis" data-name="gelir" data-time="6"  data-bs-toggle="modal" data-bs-target="#kt_modal_1"><i class="fa-solid fa-microchip-ai " style="font-size:20px"></i> 6 Ay</button>
															<button class="btn btn-light-danger  p-2 d-flex justify-content-center align-items-center kt_button_class" style="margin-right:10px" data-table="satis" data-name="gelir" data-time="12"   data-bs-toggle="modal" data-bs-target="#kt_modal_1"><i class="fa-solid fa-microchip-ai " style="font-size:20px"></i> 1 Yıl</button>
...
function googleTranslateElementInit() {
	new google.translate.TranslateElement({
			pageLanguage: 'tr', // SİTENİN ANA DİLİ
			includedLanguages: 'en,ar,ru,tr,de,fr,da' //HANGİ DİLLERE ÇEVRİLECEK? Aralarına virgül koyarak çoğaltabilirsiniz.
		},
		'google_translate_element'
	);
