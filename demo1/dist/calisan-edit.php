...
if($_SESSION['role']=="user") {
	...
	exit;
						...
						$stmt = $con->prepare("SELECT * FROM calisan where id = ?");
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Çalışan Düzenle</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Çalışan Düzenle</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"  >
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body text-center pt-0">
													...
													<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
														...
														<div class="image-input-wrapper w-150px h-150px" style="background-image: url(assets/calisan-image/<?=$user->image?>)"></div>
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="calisan_no" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Çalışan No"  value="<?=$user->no?>"/><!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ad Soyad"  value="<?=$user->ad?>"/>
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="email" name="mail" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" value="<?=$user->mail?>" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com">
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="gorev" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Görevi"  value="<?=$user->gorev?>"/>
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="bolum" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Bölümü" value="<?=$user->bolum?>"  />
																			<!--end::Input-->
																		</div>
													<!--end::Input group-->
													<!--begin::Input group-->
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="calisan.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Geri Dön</a>
												<!--end::Button-->
												<!--begin::Button-->
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
								...
								// AJAX isteği gönder
								$.ajax({
									url: 'php/calisan-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
