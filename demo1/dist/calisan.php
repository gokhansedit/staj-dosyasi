...
if(isset($_GET['add']) and !empty($_POST))
{
	...
	$stmt = $con->prepare("SELECT * FROM calisan where no=?");
	$stmt->bind_param('i',$calisanNo);
	if($stmt->execute()) 
	{
		...
		if($result->num_rows > 0)
		{
			...
			$stmt = $con->prepare("INSERT INTO calisan (no,ad,gorev,bolum,mail,image) values(?,?,?,?,?,?)");
			$stmt->bind_param('isssss',$calisanNo,$name,$gorev,$bolum,$mail,$image_name);
			if($stmt->execute())
			{
				$logId = $_SESSION['user_id'];
				$logData = "Calisan - No: ".$calisanNo." Name: ".$name." Gorev: ".$gorev." Bolum: ". $bolum;
				$action = "Added";
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Çalışan Listesi</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-header" id="kt_modal_add_user_header">
																<!--begin::Modal title-->
																<h2 class="fw-bold">Çalışan Ekle</h2>
																<!--end::Modal title-->
																<!--begin::Close-->
															...
															<div class="modal-body px-5 my-7">
																...
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	...
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Çalışan No</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="calisan_no" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Çalışan No"  /><!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="email" name="mail" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com">
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Görevi</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="gorev" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Görevi"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Bölümü</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="bolum" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Bölümü"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																	</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Katılma Tarihi</th>
													...
													<tr>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="calisan-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
