							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Kullanıcıyı Düzenle</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"  >
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body text-center pt-0">
													...
													<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
														...
														<div class="image-input-wrapper w-150px h-150px" style="background-image: url(assets/user-image/<?=$user->image?>)"></div>
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="users.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Geri Dön</a>
												<!--end::Button-->
												<!--begin::Button-->
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
								...
								// AJAX isteği gönder
								$.ajax({
									url: 'php/user-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
