...
$id = htmlspecialchars($get_id);
						$stmt = $con->prepare("SELECT * FROM siparisler where id = ?");
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Sipariş Düzenle</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Sipariş Düzenle</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"  >
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="urun-no" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ürün No" value="<?=$row->urun_no?>" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="musteri" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Müşteri"  value="<?=$row->musteri?>"/>
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="adet" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Adet" value="<?=$row->adet?>" />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Sipariş Tarihi</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="date" name="siparis_tarih" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Teslimat Tarihi"  value="<?=$row->siparis_tarih?>"/>
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="date" name="teslimat_tarih" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Teslimat Tarihi"  value="<?=$row->teslimat_tarih?>"/>
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<!--end::Label-->
																			<select class="form-select" name="durum" aria-label="Durum Seçiniz">
																				
																			<?php if($row->durum > 0 ){echo "<option value='1' selected>Tamamlandı</option>";}else{echo "<option value='0' selected>Üretimde</option>";}?>	
																				<option value="0">Üretimde</option>
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="income.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Geri Dön</a>
												<!--end::Button-->
												<!--begin::Button-->
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
								...
								// AJAX isteği gönder
								$.ajax({
									url: 'php/order-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
									...
									{
										Swal.fire({
											text: "Geçersiz Ürün No", // PHP dosyasından gelen yanıtı göster
											icon: "error",
											buttonsStyling: !1,
