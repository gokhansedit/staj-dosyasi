...
if($_SESSION['role']=="user") {
	...
	exit;
						...
						$stmt = $con->prepare("SELECT * FROM toplanti where id = ?");
						$stmt->bind_param("i",$id);
						if($stmt->execute()){
							$result = $stmt->get_result();
							$toplanti = $result->fetch_object();
							$selected = explode(',', $toplanti->katilimcilar);
						}
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Toplantı Düzenle</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Toplantı Düzenle</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"  >
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="baslik" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Başlığı"  value="<?=$toplanti->baslik?>"/>
																			<!--end::Input-->
																		</div>
																		...
																		<div class="fv-row mb-12 d-flex justify-content-between align-items-center">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="datetime-local" name="date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Tarihi"  value="<?=$toplanti->tarih?>"/> 
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="link" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Linki"  value="<?=$toplanti->link?>"/><!--end::Input-->
																		</div>
													...
													<tr>
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" name="katilimcilar[]" type="checkbox"  <?php if (in_array($row->id, $selected)) {echo "checked";} ?> value="<?=$row->id?>" />
															</div>
														</td>
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="meeting.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Geri Dön</a>
												<!--end::Button-->
												<!--begin::Button-->
												<button type="submit" id="kt_ecommerce_add_category_submit" data-id="<?=$_GET['id']?>" class="btn btn-primary">
											...
											<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7 mt-10">
																			<!--begin::Label-->
																			<h3 class=" fw-semibold fw-bold align-cente mb-2" style="text-align:center;">Katılanlar</h3>
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Bölüm</th>
														<th class="min-w-125px">Mail</th>
														<th class="min-w-125px">Katılım Saati</th>
											...
											$stmt = $con->prepare("SELECT * from toplanti_katilim  WHERE toplanti_id = ?  ORDER BY create_time DESC");
											$stmt->bind_param("i",$toplanti->id);
											if($stmt->execute())
											{
												$result = $stmt->get_result();
												while($row = $result->fetch_object())
												{
													$encrypted_id = NULL;
													$encrypted_id = urlencode(kodla($row->id));
														$calisan_cek = $con->prepare("SELECT * FROM calisan WHERE id=?");
														$calisan_cek->bind_param("i",$row->calisan_id);
														if($calisan_cek->execute())
														{
															$calisan_result = $calisan_cek->get_result();
															$calisanData = $calisan_result->fetch_object();
															$calisan_id = urlencode(kodla($calisanData->id));
														}
											...
											?>
													<tr>
														...
														<td class="d-flex align-items-center">
															<!--begin:: Avatar -->
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="calisan-edit.php?id=<?=$calisan_id?>">
																	<div class="symbol-label">
																		<img src="assets/calisan-image/<?=$calisanData->image?>" alt="Emma Smith" class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="calisan-edit.php?id=<?=$encrypted_id?>" data-kt-ecommerce-product-filter="product_name" class="text-gray-800 text-hover-primary mb-1"><?=$calisanData->ad?></a>
																<span><?=$calisanData->gorev?></span>
															</div>
															<!--begin::User details-->
														</td>
														<td><?=$calisanData->bolum?></td>
														<td><?=$calisanData->mail?></td>
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
                                ...
                                // id değerini form verilerine ekle
                                formData.append("id", dataId);
								// AJAX isteği gönder
								$.ajax({
									url: 'php/meeting-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
									success: function(response) {
										...
										Swal.fire({
											text: response, // PHP dosyasından gelen yanıtı göster
											icon: "success",
											buttonsStyling: !1,
