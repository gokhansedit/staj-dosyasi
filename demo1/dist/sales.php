...
if(isset($_GET['add']) and !empty($_POST))
{
	...
	$satisfFirma = $_POST['firma'];
			...
			$stmt = $con->prepare("INSERT INTO satis (urun_no,adet,fiyat,para_birim,firma) values(?,?,?,?,?)");
			$stmt->bind_param('siiss',$urunNo,$satisAdet,$satisFiyat,$satisBirim,$satisfFirma);
			if($stmt->execute())
			{
				$logId = $_SESSION['user_id'];
				$logData = "SALE - Product No: ".$urunNo." Sale Company: ".$satisfFirma." Sale Quantity : ".$urunAdet." Sale Price : ".$satisFiyat;
				$action = "Added";
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Satış Listesi</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">
												<a href="../../demo1/dist/graph-1.php" class="text-muted text-hover-primary">Anasayfa</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
...
<div class="alert alert-dismissible bg-danger d-flex flex-column flex-sm-row p-5 mb-10">
    <!--begin::Icon-->
    <i class="ki-duotone ki-shield-cross fs-2hx text-light me-4 mb-5 mb-sm-0 ">
 <span class="path1"></span>
 <span class="path2"></span>
 <span class="path3"></span>
    ...
    <div class="d-flex flex-column text-light pe-0 pe-sm-10">
        <!--begin::Title-->
        <h4 class="mb-2 text-white">Ürün No Geçersiz !</h4>
        <!--end::Title-->

        <!--begin::Content-->
        <span>Lüfen geçerli bir ürün no giriniz.</span>
        <!--end::Content-->
    </div>
    <!--end::Wrapper-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<?php
													if(isset($_GET['id'],$_GET['product']) and $_GET['id'] > 0 )
													{
														$get_id =  coz($_GET['product']);
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<!--end::Filter-->
													<!--begin::Export-->
													<button type="button" class="btn btn-light-primary me-3" style="margin-left:20px" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users">
															...
															<div class="modal-body px-5 my-7">
																...
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	...
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Firma Ad</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="firma" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Firma Ad"  />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Satış Adet</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="satis-adet" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Satış Adet"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<label class="required fw-semibold fs-6 mb-2">Satış Fiyatı</label>
																		...
																		<div class="col-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="satis-fiyat" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Gelir Tutarı"  /> 
																		
																		</div>
																			<div class="col-4">
																			<select class="form-select form-control form-control-solid mb-3 mb-lg-0" name="satis-birim" aria-label="Select example">
																			<option>Birim</option>
																					<option>Tl</option>
																					<option>Dolar</option>
																					<option>Euro</option>
										...
										<div class="card-body py-4">
											...
											<thead>
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="text-center min-w-70px">Satış Adet</th>
														<th class="text-center min-w-100px">Satış Fiyat</th>
												...
												if(isset($_GET['id']))
												{
													...
													$stmt = $con->prepare("SELECT * FROM satis where id = ? ORDER BY create_time DESC");
													$stmt->bind_param("i",$id);
													
												}
												else {
														$stmt = $con->prepare("SELECT * FROM satis ORDER BY create_time DESC");
													...
													<tr>
														...
														<td>
															<div class="d-flex align-items-center">
																<!--begin::Thumbnail-->
																<a href="assets/product-image/<?=$product_data->image?>" class="symbol symbol-50px">
																	<span class="symbol-label" style="background-image:url(assets/product-image/<?=$product_data->image?>);"></span>
																</a>
																<!--end::Thumbnail-->
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="sale-edit.php?id=<?=$encrypted_id?>" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"><?=$product_data->urun_ad?></a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														<td class="text-center pe-0">
															<span class="fw-bold"><?=$product_data->urun_no?></span>
														</td>
														<td class="text-center pe-0" data-order="0">
															
															<?=$row->adet?>
														</td>
														<td class="text-center pe-0"><?=number_format($row->fiyat,2,',','.')?> <?=$row->para_birim?></td>
														...
														<td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="sale-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
	...
	return {
		init: function() {
            ...
            $('#kt_ecommerce_products_table thead th').each(function(index) {
                var title = $(this).text();
                if (index !== 2 && index !==3 && index !== 4) { // 1 ve 4 sütunlarına arama eklenmez
