...
if(isset($_GET['add']) and !empty($_POST))
{
...
$sql = "SELECT mail,ad,id FROM calisan WHERE id IN ($katilimcilar)";
				$result = $con->query($sql);
				
				if ($result->num_rows > 0) {
					// PHPMailer'i başlat
				
			$stmt = $con->prepare("INSERT INTO toplanti (baslik,katilimcilar,tarih,link) values(?,?,?,?)");
			$stmt->bind_param('ssss',$baslik,$katilimcilar,$date,$link);
			if($stmt->execute())
			{
				$logId = $_SESSION['user_id'];
				$logData = "Toplantı: ".$baslik." Tarih: ".$date;
				$action = "Added";
				logActivity($logId,$action,null,$logData,null);	
				...
				try {
					...
					$mail->AddEmbeddedImage('assets/mail/images/2.png', 'img', 'assets/mail/images/2.png');
...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Bir toplantıya davet edildiniz.</span></p>
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Başlık: '.$baslik.'</span></p>
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Tarih : '.$tarih.'</span></p>
</div>
</td>
</tr>
</table>
...
<td>
					...
					echo "E-posta gönderiminde bir hata oluştu: {$mail->ErrorInfo}";
				}
			}
		}
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5 my-1">
											<a href="user-edit.php?id=<?=$_SESSION['user_id']?>" class="menu-link px-5">Hesap Ayarları</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Toplantı Listesi</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Admin İşlemleri</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-400 w-5px h-2px"></span>
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Toplantı</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search user" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<i class="ki-duotone ki-plus fs-2"></i>Ekle</button>
													<!--end::Add user-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-header" id="kt_modal_add_user_header">
																<!--begin::Modal title-->
																<h2 class="fw-bold">Toplantı Ekle</h2>
																<!--end::Modal title-->
																<!--begin::Close-->
																<div class="btn btn-icon btn-sm btn-active-icon-primary" onclick="form_close()" id="add-close">
																	<i class="ki-duotone ki-cross fs-1">
																		<span class="path1"></span>
																		<span class="path2"></span>
																	</i>
															...
															<div class="modal-body px-5 my-7">
																<!--begin::Form-->
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	<!--begin::Scroll-->
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Toplantı Başlığı</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="baslik" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Başlığı"  />
																			<!--end::Input-->
																		</div>
																		
																		<!--end::Input group-->
																		<label class="required fw-semibold fs-6 mb-2">Toplantı Tarihi</label>
																		<div class="fv-row mb-12 d-flex justify-content-between align-items-center">
																
																			
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="datetime-local" name="date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Tarihi"  /> 
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Toplantı Linki</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="link" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Toplantı Linki"  /><!--end::Input-->
																		</div>
																	...
																	<div class="fv-row mb-7 mt-10">
																			<!--begin::Label-->
																			<h3 class=" fw-semibold fw-bold align-cente mb-2" style="text-align:center;">Katılımcı Ekle</h3>
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												...
												<?php 
											$stmt = $con->prepare("SELECT * from calisan  ORDER BY no ASC");
											if($stmt->execute())
											{
													...
													<tr>
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" name="katilimcilar[]" type="checkbox" value="<?=$row->id?>" />
															</div>
														</td>
														<td class="d-flex align-items-center">
															<!--begin:: Avatar -->
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="calisan-edit.php?id=<?=$encrypted_id?>">
																	<div class="symbol-label">
																		<img src="assets/calisan-image/<?=$row->image?>" alt="Emma Smith" class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="calisan-edit.php?id=<?=$encrypted_id?>" data-kt-ecommerce-product-filter="product_name" class="text-gray-800 text-hover-primary mb-1"><?=$row->ad?></a>
																<span><?=$row->gorev?></span>
															</div>
															<!--begin::User details-->
														</td>
										...
										<div class="card-body py-4">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												...
												<tbody class="text-gray-600 fw-semibold">
												<?php 
											$stmt = $con->prepare("SELECT * from toplanti ORDER BY create_time DESC");
											if($stmt->execute())
											{
												$result = $stmt->get_result();
												while($row = $result->fetch_object())
											...
											?>
													<tr>
														...
														<td><a href="meeting-edit.php?id=<?=$encrypted_id?>"  class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"><?=$row->baslik?></a></td>
														<td><?=$row->tarih?></td>
														<td><a href="<?=$row->link?>" class="btn btn-info"><i class="fa-duotone fa-solid fa-link fa-xl" style="font-size:20px"></i> Aç</a></td>
														<td class="text-end">
															<a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">İşlemler
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
															<!--begin::Menu-->
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="meeting-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																<a href="#" class="menu-link px-3" data-kt-users-table-filter="delete_row" data-id="<?=$encrypted_id?>">Sil</a>
...
var KTAppEcommerceProducts = function() {
	...
	return {
		init: function() {
            ...
            $('#kt_ecommerce_products_table thead').append('<tr class="search-row"></tr>'),

            // Her sütun için bir th ekleyin ve belirli sütunlara arama kutusu eklemeyin
            $('#kt_ecommerce_products_table thead th').each(function(index) {
                var title = $(this).text();
                if (index !==0 && index !==1  && index !==2  && index !== 3  ) { // 1 ve 4 sütunlarına arama eklenmez
                    $('.search-row').append('<th><input type="text" class="form-control center-block form-control-solid w-75 ps-5" placeholder="Search" /></th>');
                } else {
            ...
            // Sütun arama işlevi
            e.columns().every(function(index) {
                // Belirli sütun indekslerini kontrol et
				if (index !==0 && index !==1  && index !==2  && index !== 3  ) { // 1 ve 4 sütunlarına arama eklenmez
                    var that = this;

                    $('input', $('.search-row th')[index]).on('keyup change clear', function() {
    ...
    c = () => {
        o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t => {
            t.addEventListener("click", (function(t) {
                ...
                const n = t.target.closest("tr"),
                   r = n.querySelector('[data-kt-ecommerce-product-filter="product_name"]').innerText,
                      deleteId = t.target.getAttribute('data-id'); // data-id değerini al

                Swal.fire({
                    text: "Silmek istediğinizden emin misiniz " + r + "?",
                    icon: "warning",
        ...
        init: function() {
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                const t = e.querySelectorAll("td"),
                    n = t[1].innerText.toLowerCase();
                let r = 0,
                    o = "minutes";
             
                t[1].setAttribute("data-order", c);
                const l = moment(t[1].innerHTML, "YYYY MM DD, LT").format();
                t[1].setAttribute("data-order", l)
            })), (e = $(o).DataTable({
                info: !1,
                order: [],
                pageLength: 10,
