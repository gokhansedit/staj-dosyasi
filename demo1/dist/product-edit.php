...
if($_SESSION['role']=="user") {
	...
	exit;
					...
					$id = coz($_GET['id']); // URL'den gelen şifrelenmiş veri
			
				
						$stmt = $con->prepare("SELECT * FROM urun where id = ?");
									...
									<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"  >
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body text-center pt-0">
													...
													<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
														...
														<div class="image-input-wrapper w-150px h-150px" style="background-image: url(assets/product-image/<?=$product->image?>)"></div>
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
												...
												<div class="card-body pt-0">
													...
													<div class="fv-row mb-7">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="urun-ad" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ürün Ad" value="<?=$product->urun_ad?>"  />
																			<!--end::Input-->
																		</div>
																	
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Ürün Adet</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="urun-adet" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ürün Adet" value="<?=$product->urun_adet?>"  />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Ürün Fiyat</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="number" name="urun-fiyat" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ürün Fiyat" value="<?=$product->urun_fiyat?>"  />
																			<!--end::Input-->
																		</div>
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="products.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Geri Dön</a>
												<!--end::Button-->
												<!--begin::Button-->
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
								...
								// AJAX isteği gönder
								$.ajax({
									url: 'php/product-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
