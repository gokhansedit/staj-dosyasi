...
if(isset($_GET['add']) and !empty($_POST))
{
	...
	if($stmt->execute()) 
	{
		...
		if($result->num_rows > 0)
		{
			...
			$stmt = $con->prepare("INSERT INTO user (mail,password,name,image,role) values(?,?,?,?,?)");
			$stmt->bind_param('sssss',$mail,$password,$name,$image_name,$user_role);
			if($stmt->execute())
			{
				$logId = $_SESSION['user_id'];
				$logData = "Mail: ".$mail." Name: ".$name." Role: ".$user_role;
				$action = "Added";
...
if(isset($_GET['save']) and !empty($_POST))
{
	$mail = $_POST['user_email'];
	$name = $_POST['name'];
	$password = $_POST['user_password'];
									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												<!--begin::Toolbar-->
												<div class="d-block justify-content-end " data-kt-user-table-toolbar="base">
													<!--begin::Filter-->
																...
																<form id="kt_modal_add_user_form" class="form" action="?add=1" enctype="multipart/form-data" method="POST">
																	...
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ad Soyad"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="email" name="user_email" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus=""  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com"  />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			...
																			<div class="d-flex fv-row">
																				...
																				<div class="form-check form-check-custom form-check-solid">
																					...
																					<label class="form-check-label" for="kt_modal_update_role_option_0">
																						<div class="fw-bold text-gray-800">Yönetici</div>
																						<div class="text-gray-600">Site Yöneticiliğini Yapar</div>
																					</label>
																					<!--end::Label-->
																				</div>
																				<!--end::Radio-->
																			...
																			<div class="d-flex fv-row">
																				...
																				<div class="form-check form-check-custom form-check-solid">
																					...
																					<label class="form-check-label" for="kt_modal_update_role_option_1">
																						<div class="fw-bold text-gray-800">Kullanıcı</div>
																						<div class="text-gray-600">Belirli Verilere Erişebilir</div>
																					</label>
																					<!--end::Label-->
																				</div>
																				<!--end::Radio-->
...
<div class="modal fade" tabindex="-1" id="kt_modal_1">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form id="kt_modal_add_user_form" class="form" action="?save=<?=$user->id?>" enctype="multipart/form-data" method="POST">
																	<!--begin::Scroll-->
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
																				<!--begin::Preview existing avatar-->
																				<div class="image-input-wrapper w-125px h-125px" style="background-image: url(assets/user-image/<?=$user->image?>);"></div>
																				<!--end::Preview existing avatar-->
																				<!--begin::Label-->
																				<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
																					<i class="ki-duotone ki-pencil fs-7">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Ad Soyad" value="<?=$user->name?>"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="email" name="user_email" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" value="<?=$user->mail?>"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com"  />
																			<!--end::Input-->
																		</div>
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																		...
																		<div class="mb-5">
																			...
																			<div class="d-flex fv-row">
																				...
																				<div class="form-check form-check-custom form-check-solid">
																					<!--begin::Input-->
																					<input class="form-check-input me-3" name="role" type="radio" value="admin" id="kt_modal_update_role_option_0" <?php if($user->role=="admin"){echo"checked";}?> />
																					<!--end::Input-->
																					<!--begin::Label-->
																					<label class="form-check-label" for="kt_modal_update_role_option_0">
																						<div class="fw-bold text-gray-800">Yönetici</div>
																			...
																			<div class="d-flex fv-row">
																				...
																				<div class="form-check form-check-custom form-check-solid">
																					<!--begin::Input-->
																					<input class="form-check-input me-3" name="role" type="radio" value="user" id="kt_modal_update_role_option_1"  <?php if($user->role=="user"){echo"checked";}?>/>
																					<!--end::Input-->
																					<!--begin::Label-->
																					<label class="form-check-label" for="kt_modal_update_role_option_1">
																						<div class="fw-bold text-gray-800">Kullanıcı</div>
...
<?php } ?>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Katılım Tarihi</th>
														<th class="text-end min-w-100px">İŞlemler</th>
													</tr>
												</thead>
												<tbody class="text-gray-600 fw-semibold">
												<?php 
											$stmt = $con->prepare("SELECT * from user where id <>".$encrypted_userId."  ORDER BY name ASC");
											if($stmt->execute())
											{
												$result = $stmt->get_result();
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="user-edit.php?id=<?=$encrypted_id?>">
																	<div class="symbol-label">
																		<img src="assets/user-image/<?=$row->image?>" class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															<!--begin::User details-->
															<div class="d-flex flex-column">
																<a href="user-edit.php?id=<?=$encrypted_id?>" data-kt-ecommerce-product-filter="product_name" class="text-gray-800 text-hover-primary mb-1"><?=$row->name?></a>
																<span><?=$row->mail?></span>
															</div>
															<!--begin::User details-->
														</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="user-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Düzenle</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
		...
		<script>
		function form_close(){
		var t = document.getElementById("kt_modal_add_user")
	...
	return {
        init: function() {
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                ...
                const l = moment(t[3].innerHTML, "YYYY MM DD, LT").format();
