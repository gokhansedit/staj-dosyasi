...
if($_SESSION['role']=="user") {
	...
	exit;
						...
						$stmt = $con->prepare("SELECT * FROM gelir where id = ?");
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Gelir Düzenle</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Gelir Düzenle</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Gelir Ad</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="gelirAd" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Gelir Ad" value="<?=$product->gelirAd?>"  />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																		<!--begin::Input group-->
																...
																<div class="col-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="number" name="gelirTutar" class="form-control form-control-solid mb-3 mb-lg-0" value="<?=$product->gelirTutar?>" placeholder="Gelir Tutarı"> 
																
																</div>
																	<div class="col-4">
																	<select class="form-select form-control form-control-solid mb-3 mb-lg-0" name="gelirTur" aria-label="Select example">
																	<option  selected ><?=$product->gelirTur?></option>
																			<option>Tl</option>
																			<option>Dolar</option>
																			<option>Euro</option>
																	...
																	<!--end::Input-->
																		...
																		<div class="fv-row mb-7">
																			<!--begin::Label-->
																			<label class="required fw-semibold fs-6 mb-2">Gelir Firma</label>
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="firma" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Gelir firma" value="<?=$product->gelirFirma?>"  />
																			<!--end::Input-->
																		</div>
					...
					e && e.validate().then((function(e) {
						...
						if ("Valid" == e) {
							...
							setTimeout((function() {
								...
								// AJAX isteği gönder
								$.ajax({
									url: 'php/income-edit-save.php?', // PHP dosyanızın yolu
									type: 'POST',
									data: formData,
									processData: false,
									contentType: false,
