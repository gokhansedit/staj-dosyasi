									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6 w-100">
											...
											<div class="card-toolbar ">
												<!--begin::Toolbar-->
												<div class="d-block justify-content-start " data-kt-user-table-toolbar="base">
													<!--begin::Filter-->
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-body px-5 my-7">
																<!--begin::Form-->
																<form id="kt_modal_add_user_form" class="form" action="mobile/users.php?add=1" enctype="multipart/form-data" method="POST">
																	<!--begin::Scroll-->
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="../../demo1/dist/apps/user-management/users/view.html">
																	<div class="symbol-label">
																		<img src="assets/user-image/<?=$row->image?>" alt="Emma Smith" class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															...
															<div class="d-flex flex-column">
																<a href="mobile/user-edit.php?id=<?=$encrypted_id?>" data-kt-ecommerce-product-filter="product_name" class="text-gray-800 text-hover-primary mb-1"><?=$row->name?></a>
																<span><?=$row->mail?></span>
															</div>
															<!--begin::User details-->
														</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="mobile/user-edit.php?id=<?=$encrypted_id?>" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																<a  class="menu-link px-3" data-kt-users-table-filter="delete_row" data-id="<?=$encrypted_id?>">Sil</b>
            ...
            t.addEventListener("click", (function(t) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                            ...
                            $.ajax({
                                url: 'http://localhost/demo1/dist/php/user-delete.php',
                                type: 'GET',
